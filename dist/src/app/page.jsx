        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              ...
              <h1 className="ml-3 text-2xl font-bold text-gray-900">PlanD</h1>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          <h1 className="text-4xl font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            Welcome to{" "}
            <span className="text-indigo-600">PlanD</span>
          </h1>
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Professional school absence management solution designed for administrators. 
            Streamline your absence tracking, reporting, and compliance processes.
          </p>
        ...
        <div className="mt-16">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <h3 className="mt-4 text-lg font-medium text-gray-900">Absence Tracking</h3>
              <p className="mt-2 text-sm text-gray-500">
                Easily track and manage student absences with our intuitive interface.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <p className="mt-2 text-sm text-gray-500">
                Built with security in mind and compliant with educational data standards.
              </p>
            </div>
          </div>
        </div>
